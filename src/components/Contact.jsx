      ...
      >
        ...
        <div className='flex flex-wrap justify-center gap-4 mt-8'>
          <a href='mailto:huynhbaokhangduong@gmail.com'
            className='flex items-center justify-center gap-2 bg-tertiary py-3 px-6 rounded-xl text-white font-medium shadow-md shadow-primary hover:brightness-110 transition-all duration-200 w-[180px]'
          >
