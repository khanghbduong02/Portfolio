      ...
      >
        ...
        <div className='flex flex-wrap justify-center gap-4 mt-8'>
          <a href='mailto:huynhbaokhangduong@gmail.com'
            className='flex-1 max-w-[150px] flex items-center justify-center gap-2 bg-tertiary hover:bg-white/10 border border-white/20 transition-colors duration-200 rounded-xl text-white font-medium min-w-[130px] py-3 px-4 shadow-md shadow-primary'
          >
        ...
        >
          <label className='flex flex-col'>
            ...
            <input
              ...
              className='bg-tertiary border border-white/20 py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none font-medium focus:border-white/40 transition-colors duration-200'
            />
          </label>
          <label className='flex flex-col'>
          ...
          <button
            type='submit'
            className='flex items-center justify-center gap-2 bg-tertiary hover:bg-white/10 border border-white/20 transition-colors duration-200 rounded-xl text-white font-medium py-3 px-6 shadow-md shadow-primary w-full'
          >
